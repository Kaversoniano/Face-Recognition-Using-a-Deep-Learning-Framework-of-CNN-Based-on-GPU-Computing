...
net = Network([ConvPoolLayer(image_shape=(mini_batch_size, 1, 192, 168),
               ...
               FullyConnectedLayer(n_in=20*81*69, n_out=200, activation_fn=network3.ReLU, p_dropout=0.5),
...
# Logs:
# best validation accuracy to date: 97.50% (49th epoch), its corresponding test accuracy: 98.06%
